...
function pgCanvas1_contLineGraph1_OnTouchEnded(e) {
    if (Device.deviceOS == "Android") {
        header.init(Pages.pgCanvas2, canvasHeader, canvasStatusBarColor, "Line Chart 1");
...
function pgCanvas1_contLineGraph2_OnTouchEnded(e) {
    if (Device.deviceOS == "Android") {
        header.init(Pages.pgCanvas3, canvasHeader, canvasStatusBarColor, "Line Chart 2");
        header.setLeftItem(pagesBack);
        header.setRightItem(Dialogs.dlgCanvasLineInfo);
    }
...
function pgCanvas1_contBarGraph_OnTouchEnded(e) {
    if (Device.deviceOS == "Android") {
        header.init(Pages.pgCanvas5, canvasHeader, canvasStatusBarColor, "Bar Graph");
        header.setLeftItem(pagesBack);
        header.setRightItem(Dialogs.dlgCanvasLineInfo);
    }
